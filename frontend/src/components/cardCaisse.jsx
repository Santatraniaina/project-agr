...
import { FaCashRegister, FaArrowRight } from 'react-icons/fa';
    ...
    <div className="group relative backdrop-blur-xl bg-white/20 rounded-xl shadow-[0_8px_32px_0_rgba(31,38,135,0.2)] hover:shadow-[0_8px_32px_0_rgba(31,38,135,0.3)] p-6 w-full max-w-md mx-auto min-h-[320px] transition-all duration-700 ease-[cubic-bezier(0.34,1.56,0.64,1)] border border-white/40 hover:border-white/60 overflow-hidden hover:-translate-y-2">
      ...
      <div className="relative z-10 flex flex-col items-center h-full">
        ...
        <div className="flex flex-col items-center text-center mb-6">
          <div className="relative p-5 backdrop-blur-lg bg-red-500/80 rounded-2xl shadow-lg mb-3 transform group-hover:scale-110 transition-all duration-700 ease-[cubic-bezier(0.34,1.56,0.64,1)] group-hover:shadow-red-200/50 border border-white/20">
            <FaCashRegister className="text-5xl text-white/90 relative z-10 transform group-hover:scale-105 transition-transform duration-700 ease-out" />
          </div>
          <div className="transform transition-all duration-500 ease-out">
            <h2 className="text-2xl font-bold text-gray-800/90 group-hover:text-red-600/90 transition-all duration-700 ease-in-out">
              CAISSE
            </h2>
            <p className="text-xs text-gray-500/80 mt-1 transition-all duration-500 ease-out group-hover:text-red-500/70">
        ...
        <div className="relative h-[1.5px] w-full mb-6 overflow-hidden backdrop-blur-sm">
          ...
          <div className="h-full bg-red-400/50 backdrop-blur-sm w-0 group-hover:w-full transition-all duration-1000 ease-[cubic-bezier(0.34,1.56,0.64,1)]"></div>
        </div>
        ...
        <div className="w-full flex justify-between items-center mt-auto">
          ...
          <button 
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg backdrop-blur-md bg-white/10 border border-white/30 hover:bg-white/20 text-red-600/90 hover:text-red-700/90 transition-all duration-500 ease-out group-hover:translate-x-2 hover:shadow-lg hover:shadow-white/20"
          >
