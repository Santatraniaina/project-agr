     ...
     onClick={handleClick}>
      ...
      <div className="relative z-10 flex flex-col items-center h-full">
        ...
        <div className="flex flex-col items-center text-center mb-6">
          <div className="relative p-5 backdrop-blur-lg bg-blue-500/80 rounded-2xl shadow-lg mb-3 transform group-hover:scale-110 transition-all duration-700 ease-[cubic-bezier(0.34,1.56,0.64,1)] group-hover:shadow-blue-200/50 border border-white/20">
            <FaUserTie className="text-5xl text-white/90 relative z-10 transform group-hover:scale-105 transition-transform duration-700 ease-out" />
          </div>
          <div className="transform transition-all duration-500 ease-out">
            <h2 className="text-2xl font-bold text-gray-800/90 group-hover:text-blue-600/90 transition-all duration-700 ease-in-out">
              UTILISATEURS
            </h2>
            <p className="text-xs text-gray-500/80 mt-1 transition-all duration-500 ease-out group-hover:text-blue-500/70">
        ...
        <div className="relative h-[1.5px] w-full mb-6 overflow-hidden backdrop-blur-sm">
          ...
          <div className="h-full bg-blue-400/50 backdrop-blur-sm w-0 group-hover:w-full transition-all duration-1000 ease-[cubic-bezier(0.34,1.56,0.64,1)]"></div>
        </div>
        ...
        <p className="text-gray-700/90 text-base text-center mb-6 flex-grow backdrop-blur-sm transform transition-all duration-700 ease-out group-hover:text-gray-800/90 px-3">
          Voir et gérer les utilisateurs et les personnels du système.
        </p>
        ...
        <div className="w-full flex justify-between items-center mt-auto">
          ...
          <button  
          onClick={handleClick}
          className="flex items-center gap-2 px-4 py-2 rounded-lg backdrop-blur-md bg-white/10 border border-white/30 hover:bg-white/20 text-blue-600/90 hover:text-blue-700/90 transition-all duration-500 ease-out group-hover:translate-x-2 hover:shadow-lg hover:shadow-white/20">
